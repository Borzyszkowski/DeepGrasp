""" Renders right hand from GRAB as .gif, .mp4 or .png snapshots """
...
def render_rhand_interaction(cfg):
    """ Create visualization for rendering of the right hand in MeshViewer. """
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Right-Hand-Interaction-render')
